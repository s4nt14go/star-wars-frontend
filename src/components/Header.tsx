...
function Header(){
  ...
  return <section className="text-gray-600 body-font">
    <div className="flex flex-col text-center w-full mb-4">
      <div>
      <img alt='Chewbacca' src={chewbacca} className='mx-auto inline md:w-28 w-1/4 my-4' onLoad={() => setImgLoaded(true)}/>
      { !imgLoaded && <img alt='Chewbacca' src={placeholder} className='mx-auto inline md:w-28 w-1/4 my-4' /> }
      </div>
